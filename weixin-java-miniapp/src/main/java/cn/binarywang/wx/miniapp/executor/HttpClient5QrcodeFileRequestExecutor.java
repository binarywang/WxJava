 ...
 * @author altusea
 */
public class HttpClient5QrcodeFileRequestExecutor extends QrcodeRequestExecutor<CloseableHttpClient, HttpHost> {

  private final String filePath;

  public HttpClient5QrcodeFileRequestExecutor(RequestHttp<CloseableHttpClient, HttpHost> requestHttp, String filePath) {
    super(requestHttp);
