...
public class MaQrCodeHttpClient5RequestExecutor extends MaQrCodeRequestExecutor<CloseableHttpClient, HttpHost> {
  public MaQrCodeHttpClient5RequestExecutor(RequestHttp<CloseableHttpClient, HttpHost> requestHttp) {
    super(requestHttp);
  }
