 ...
 * @author altusea
 */
public class CommonUploadMultiRequestExecutorHttpClient5Impl extends CommonUploadMultiRequestExecutor<CloseableHttpClient, HttpHost> {

  public CommonUploadMultiRequestExecutorHttpClient5Impl(RequestHttp<CloseableHttpClient, HttpHost> requestHttp) {
    super(requestHttp);
  }
