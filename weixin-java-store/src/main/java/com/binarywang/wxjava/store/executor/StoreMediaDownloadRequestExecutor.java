 ...
 */
public abstract class StoreMediaDownloadRequestExecutor<H, P> implements RequestExecutor<StoreImageResponse, String> {
  ...
  public static RequestExecutor<StoreImageResponse, String> create(RequestHttp<?, ?> requestHttp, File tmpDirFile) {
    switch (requestHttp.getRequestType()) {
      case APACHE_HTTP:
        return new ApacheHttpStoreMediaDownloadRequestExecutor(
