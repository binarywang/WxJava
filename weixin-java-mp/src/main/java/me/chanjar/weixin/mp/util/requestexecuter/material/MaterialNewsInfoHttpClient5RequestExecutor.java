...
@Slf4j
public class MaterialNewsInfoHttpClient5RequestExecutor extends MaterialNewsInfoRequestExecutor<CloseableHttpClient, HttpHost> {

  public MaterialNewsInfoHttpClient5RequestExecutor(RequestHttp<CloseableHttpClient, HttpHost> requestHttp) {
    super(requestHttp);
  }
