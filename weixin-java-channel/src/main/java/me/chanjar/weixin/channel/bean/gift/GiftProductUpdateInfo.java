 ...
 * @see <a href="https://developers.weixin.qq.com/doc/store/shop/API/channels-shop-product/gift/api_updategiftproduct.html">更新非卖商品</a>
 */
@Data
@NoArgsConstructor
...
public class GiftProductUpdateInfo implements Serializable {
  ...
  @JsonProperty("skus")
  private List<GiftProductUpdateSkuInfo> skus;
}
