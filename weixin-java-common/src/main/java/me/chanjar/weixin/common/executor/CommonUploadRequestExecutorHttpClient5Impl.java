 ...
 */
public class CommonUploadRequestExecutorHttpClient5Impl extends CommonUploadRequestExecutor<CloseableHttpClient, HttpHost> {

  public CommonUploadRequestExecutorHttpClient5Impl(RequestHttp<CloseableHttpClient, HttpHost> requestHttp) {
    super(requestHttp);
  }
